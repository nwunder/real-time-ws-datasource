define(["app/plugins/sdk","lodash","moment"], function(__WEBPACK_EXTERNAL_MODULE_457__, __WEBPACK_EXTERNAL_MODULE_56__, __WEBPACK_EXTERNAL_MODULE_161__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var SubscriptionLog_1 = __webpack_require__(155);
...
var _datasource = __webpack_require__(159);

var _query_ctrl = __webpack_require__(456);
...
var _stream_handler = __webpack_require__(160);
...
var GenericDatasource = exports.GenericDatasource = function () {
  ...
  _createClass(GenericDatasource, [{
    ...
    value: function query(options) {
      ...
      this.streamHandlers[options.panelId] = handler = new _stream_handler.StreamHandler(options, this);

      console.log('Creating handler', handler);
...
var StreamHandler = exports.StreamHandler = function () {
  function StreamHandler(options, datasource, metrics) {
    _classCallCheck(this, StreamHandler);

    this.options = options;
    this.ds = datasource;
    this.subject = new _Rx.Subject();
    this.delta = false;
    this.metrics = {};
  }
  ...
  _createClass(StreamHandler, [{
    ...
    value: function start() {
      ...
      var interval = _moment2.default.duration(parseInt(target.interval, 10)).milliseconds();
      // if (interval < 1000) {
      //   interval = 1000;
      // }
      ...
      var self = this;
      this.source = _Rx.Observable.interval(interval).subscribe(function (data) {
        var time = new Date().getTime();
        var fakeData = _this.options.targets.map(function (target) {
          var datum = {};
    ...
    value: function processMetricEvent(data) {
      ...
      _.forEach(data, function (d) {
        var series = _this2.metrics[d.target];
        if (!series) {
          _this2.startTime = new Date().getTime();
          series = { target: d.target, datapoints: [], delta: _this2.delta };
          _this2.metrics[d.target] = series;
        }

        _this2.endTime = d.time;
        _this2.startTime = _this2.endTime - 60 * 1 * 200;
      ...
      var datum = {
        data: seriesList,
        range: { from: (0, _moment2.default)(this.startTime), to: (0, _moment2.default)(this.endTime) }
      };
      console.log(datum);
...
var switchAll_1 = __webpack_require__(135);
/**
 * Converts a higher-order Observable into a first-order Observable by
...
var switchMapTo_1 = __webpack_require__(136);
/* tslint:enable:max-line-length */
/**
 * Projects each source value to the same Observable which is flattened multiple
 * times with {@link switch} in the output Observable.
...
var async_1 = __webpack_require__(4);
var timeout_1 = __webpack_require__(143);
/**
 *
 * Errors if Observable does not emit a value in given time span.
 *
...
var Observable_1 = __webpack_require__(0);
var Subscription_1 = __webpack_require__(5);
var SubscriptionLoggable_1 = __webpack_require__(154);
var applyMixins_1 = __webpack_require__(156);
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @ignore
 * @extends {Ignored}
...
var _sdk = __webpack_require__(457);
